...
List<Widget> notes = [
  Text(
      "Sinds september de meest populaire uitgaansgelegenheid in het RGB café op het Stratumseind. De naam RGB komt van de drie kanalen Rood Groen of Blauw die op koptelefoon gekozen kan worden. "),
